...
public class StateTestRunner {
    ...
    public List<String> runImpl() {
        ...
        blockchain = new BlockChainImpl(repository, blockStore, null, null, null, null, new BlockExecutor(repository, (tx1, txindex1, coinbase, track1, block1, totalGasUsed1) -> new TransactionExecutor(
                tx1,
                txindex1,
                block1.getCoinbase(),
                track1,
